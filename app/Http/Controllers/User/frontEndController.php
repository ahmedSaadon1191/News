...
class frontEndController extends Controller
{
    ...
    public function category_posts($id)
    {
        ...
        return view('frontEnd.category_posts',compact('categories','ads','category','chunk_most_read'));
    }
    ...
    public function post($id)
    {
       ...
       if ($post && $post->count() > 0)
       {
        ...
        return view('frontEnd.post',compact('categories','ads','post','chunk_most_read','next_post','other_posts'));
       }
